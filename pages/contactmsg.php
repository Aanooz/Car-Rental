        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-item  px-3 nav-link active " href="../pages/contactmsg.php">Contact Msg</a>
                    </li>
                    <li class="nav-item ">
...
<body>
    ...
    <section class="p-3 bg-light">
        <div class="container ">
        <h3 class="text-center text-white bg-success">Message from users.</h3>
                <hr><br><br>
            <table class="table">
...
<td>' . $row['message'] . '</td>
<td>' . $row['date'] . '</td>
<td><a href="../include/deleteBooking.inc.php?mid='. $row['mid'] .'" class="btn btn-danger">Delete</a></td>
</tr>
';
                }
                ?>
